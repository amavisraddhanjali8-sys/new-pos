...
export function getAwsDbConfig(): AwsDbConfig {
  ...
  const resourceArn = process.env.inposdbaws_AWS_RESOURCE_ARN || process.env.AWS_RDS_RESOURCE_ARN || 'arn:aws:rds:us-east-1:041436772015:cluster:innovistaposdbaws';
  const roleArn = process.env.inposdbaws_AWS_ROLE_ARN || process.env.AWS_IAM_ROLE_ARN || 'arn:aws:iam::041436772015:role/Vercel/access-innovistaposdbaws';
