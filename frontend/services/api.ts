...
export async function testAwsDatabaseConnection(): Promise<any> {
...
export async function syncAwsDatabase(direction: 'push' | 'pull' = 'push'): Promise<{ success: boolean; message: string }> {
